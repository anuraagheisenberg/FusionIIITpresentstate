# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-01-18 14:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specialization', models.CharField(choices=[(b'0', b'Cardiology'), (b'1', b'Oncology'), (b'2', b'Gynaecology'), (b'3', b'Radiology'), (b'4', b'General Practitioner'), (b'5', b'Primary Care Physician'), (b'6', b'Opthomology'), (b'7', b'Dental')], max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='Health_Card',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('test_file', models.FileField(blank=True, null=True, upload_to=b'Administrator/health_center/')),
